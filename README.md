...
### [查看博客戳这里 👆](https://www.liniaoniao.website)
...
friends: [
    {
        title: "BY Blog",
        href: "https://libangchui.github.io/"
    },
    {
        title: "Apple",
...
# Google Analytics
ga_track_id: 'G-64Q90HW6RM'            # 你用Google账号去注册一个就会给你一个这样的id
ga_domain: Liniaoniao.website			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
